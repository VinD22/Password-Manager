...
/**
 * Activity to update the key for the app!
 */

public class UpdateKey extends AppCompatActivity {
        ...
        mSaveKey.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(enteredKey.isEmpty() || reEnteredKey.isEmpty()) {
                    Toast.makeText(UpdateKey.this, R.string.empty_fields, Toast.LENGTH_SHORT).show();
                } else if(!enteredKey.equals(reEnteredKey)) {
                    Toast.makeText(UpdateKey.this, R.string.keys_should_be_same, Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    startActivity(new Intent(UpdateKey.this, MainActivity.class));
                    finish();
